...
if [ "${0:0:5}" != "/tmp/" ] ; then
	...
	echo
	echo "Please send feedback to qa-jenkins-dev@lists.alioth.debian.org or even better, provide https://salsa.debian.org/qa/jenkins.debian.net/merge_requests !"
	echo

...
build_jenkins_job_health_page() {
	...
	FILTER[8]="edu-packages"
	FILTER[9]="haskell"
	FILTER[10]="chroot-installation_sid"
	FILTER[11]="chroot-installation_bullseye"
	FILTER[12]="chroot-installation_buster"
	FILTER[13]="chroot-installation_stretch"
	FILTER[14]="chroot-installation_jessie"
	FILTER[15]="d-i_overview"
	FILTER[16]="d-i_manual"
	FILTER[17]="d-i_build"
	FILTER[18]="d-i_schroot"
	FILTER[19]="d-i_:(overview|manual|build|schroot)"
	FILTER[20]="rebootstrap"
	FILTER[21]="g-i-installation_debian_jessie:(presentation|rescue)"
	FILTER[22]="g-i-installation_debian_sid:(presentation|rescue)"
